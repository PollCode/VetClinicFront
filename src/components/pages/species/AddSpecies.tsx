...
interface SpeciesCreationFormProps {
  isOpen: boolean;
  onClose: () => void;
...
// Definición de tipos
type SpeciesFormData = z.infer<typeof createSpeciesSchema>;

const SpeciesCreationForm: React.FC<SpeciesCreationFormProps> = ({
  isOpen,
  onClose,
  onSpeciesCreated,
}) => {
...
export default SpeciesCreationForm;
